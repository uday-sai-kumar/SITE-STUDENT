...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.example.udaysaikumar.clgattendance.Fragments.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.example.udaysaikumar.clgattendance.Fragments.GlideOptions().apply(toSet));
    }
  }
}
